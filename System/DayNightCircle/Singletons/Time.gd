...
var IN_GAME_SECONDS_PER_REAL_TIME_SECONDS: int = 5400
...
func _ready():
	...
	game_start_year = datetime.year
	game_start_month = datetime.month
	game_start_hour = datetime.hour
	game_start_day = datetime.day
